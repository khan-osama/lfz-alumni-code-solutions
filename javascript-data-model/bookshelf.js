...
console.log('The author of the book JSON Quick Syntax Reference is', bookshelf[1].author);
console.log('The ISBN of the book Introduction to JavaScript Object Notation is', bookshelf[0].isbn);
